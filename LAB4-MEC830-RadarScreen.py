# based on the code written by Joshua Hrisko March 31, 2020
...
# Find Arudino ports: WINDOWS and MAC
def port_search():
...
ax = fig.add_subplot(111, polar=True, facecolor='#06470c')
...
ax.tick_params(axis='both', colors='#01ff07')
ax.grid(color='#01ff07', alpha=0.5)  # grid color
...
ax.minorticks_on()
ax.grid(which='minor', linestyle=':', linewidth='0.5', color='#01ff07')
...
pols, = ax.plot([], linestyle='', marker='o', markerfacecolor='#c7fdb5',
                markeredgecolor='#EFEFEF', markeredgewidth=0,
                markersize=10.0, alpha=0.9)  # dots for radar points
line1, = ax.plot([], color='#c7fdb5',
                 linewidth= 0.5)  # sweeping arm plot
